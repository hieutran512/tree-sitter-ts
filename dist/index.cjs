...
__export(index_exports, {
  ...
  extractSymbolsFromTokens: () => extractSymbolsFromTokens,
  extractSymbolsWithProfile: () => extractSymbolsWithProfile,
  findBlockSpans: () => findBlockSpans,
  getCompiledLexer: () => getCompiledLexer,
  ...
  swift: () => swift,
  tokenize: () => tokenize,
  tokenizeWithProfile: () => tokenizeWithProfile,
  toml: () => toml,
